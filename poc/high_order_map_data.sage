...
p256_map = HighOrderMap(p256_p, p256_A, p256_B, 1, 0, None, -1)

# NIST P-384 - see FIPS-186-4
p384_map = HighOrderMap(p384_p, p384_A, p384_B, 1, 0, None, -1)

# NIST P-521 - see FIPS-186-4
p521_map = HighOrderMap(p521_p, p521_A, p521_B, 1, 0, None, -1)
...
b512_gx = 3
b512_gy = None
b512_map = HighOrderMap(b512_q, b512_a, b512_b, b512_h, b512_gx, b512_gy, b512_delta)
...
wei25519_h = 8
wei25519_map = HighOrderMap(wei25519_q, wei25519_a, wei25519_b, wei25519_h, 3, None, 2)
wei25519_2_map = HighOrderMap(wei25519_q, 2, wei25519_2_b, wei25519_h, 244, None, 2)
wei25519_n3_map = HighOrderMap(wei25519_q, -3, wei25519_n3_b, wei25519_h, 41, None, 2)
...
wei448_h = 4
wei448_map = HighOrderMap(wei448_q, wei448_a, wei448_b, wei448_h, 18, None, -1)
wei448_1_map = HighOrderMap(wei448_q, 1, wei448_1_b, wei448_h, 10, None, -1)
wei448_n3_map = HighOrderMap(wei448_q, -3, wei448_n3_b, wei448_h, 8, None, -1)
