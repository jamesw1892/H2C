...
try:
    ...
    from sagelib.suite_p256 import p256_F, p256_A, p256_B
    from sagelib.suite_p384 import p384_F, p384_A, p384_B
    from sagelib.suite_p521 import p521_F, p521_A, p521_B
    from sagelib.suite_secp256k1 import secp256k1_F, secp256k1_A, secp256k1_B
except ImportError as e:
    sys.exit("Error loading preprocessed sage files. Try running `make clean pyfiles`. Full error: " + e)

# NIST P-224 - see FIPS-186-4
p224_F = GF(26959946667150639794667015087019630673557916260026308143510066298881)
p224_A = -3
...
b224_F = GF(0xD7C134AA264366862A18302575D1D787B09F075797DA89F57EC8C0FF)
...
b256_F = GF(0xA9FB57DBA1EEA9BC3E660A909D838D726E3BF623D52620282013481D1F6E5377)
...
b320_F = GF(0xD35E472036BC4FB7E13C785ED201E065F98FCFA6F6F40DEF4F92B9EC7893EC28FCD412B1F1B32E27)
...
b384_F = GF(0x8CB91E82A3386D280F5D6F7E50E641DF152F7109ED5456B412B1DA197FB71123ACD3A729901D1A71874700133107EC53)
...
b512_F = GF(0xAADD9DB8DBE9C48B3FD4E6AE33C9FC07CB308DB3B3C9D20ED6639CCA703308717D4D9B009BC66842AECDA12AE6A380E62881FF2F2D82C68528AA6056583A48F3)
...
#             Name                   F            A            B         P0.x      P0.y     non-square
HighOrderMap("NIST P-224",      p224_F,      p224_A,      p224_B,        p224_gx,  p224_gy, 11)
HighOrderMap("NIST P-256",      p256_F,      p256_A,      p256_B,        0,        None,    -1)
HighOrderMap("NIST P-384",      p384_F,      p384_A,      p384_B,        0,        None,    -1)
HighOrderMap("NIST P-521",      p521_F,      p521_A,      p521_B,        0,        None,    -1)
HighOrderMap("brainpoolP224r1", b224_F,      b224_A,      b224_B,        b224_gx,  b224_gy, -1)
HighOrderMap("brainpoolP256r1", b256_F,      b256_A,      b256_B,        b256_gx,  b256_gy, -1)
HighOrderMap("brainpoolP320r1", b320_F,      b320_A,      b320_B,        b320_gx,  b320_gy, -1)
HighOrderMap("brainpoolP384r1", b384_F,      b384_A,      b384_B,        b384_gx,  b384_gy, -1)
HighOrderMap("brainpoolP512r1", b512_F,      b512_A,      b512_B,        3,        None,    -1)
# HighOrderMap("Curve25519"   , F,           A,           B,             90,       None,     2) # montgomery curve
HighOrderMap("Wei25519"       , wei25519_F,  wei25519_A,  wei25519_B,    3,        None,     2)
HighOrderMap("Wei25519.2"     , wei25519_F,  2,           wei25519_2_B,  244,      None,     2)
HighOrderMap("Wei25519.-3"    , wei25519_F, -3,           wei25519_n3_B, 41,       None,     2)
# HighOrderMap("Curve448"     , F,           A,           B,             50,       None,    -1) # montgomery curve
HighOrderMap("Wei448"         , wei448_F,    wei448_A,    wei448_B,      18,       None,    -1)
HighOrderMap("Wei448.1"       , wei448_F,    1,           wei448_1_B,    10,       None,    -1)
HighOrderMap("Wei448.-3"      , wei448_F,   -3,           wei448_n3_B,   8,        None,    -1)
# HighOrderMap("secp256k1.m"  , secp256k1_F, secp256k1_A, secp256k1_B,   0,        None,    -1) # A = 0, need to use isogeny
